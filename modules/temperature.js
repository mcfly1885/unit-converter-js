...
function celsiusTokelvin(celsius){
    ...
    let result = Number.parseFloat(celsius + 273.15).toPrecision(FIXED);
    return result;
}

function celsiusTofahrenheit(celsius){
    celsius = parseFloat(celsius);
    let result = Number.parseFloat(celsius*9/5+32).toPrecision(FIXED);
    return result;
}
...
function kelvinTocelsius(kelvin){
    ...
    let result = Number.parseFloat(kelvin-273.15).toPrecision(FIXED);
    return result;
}

function kelvinTofahrenheit(kelvin){
    kelvin = parseFloat(kelvin);
    let result = Number.parseFloat((kelvin-273.15)*9/5+32).toPrecision(FIXED);
    return result;
}
//fahrenheit-----------------------------
function fahrenheitTocelsius(fahrenheit){
    fahrenheit = parseFloat(fahrenheit);
    let result = Number.parseFloat((fahrenheit-32)*5/9).toPrecision(FIXED);
    return result;
}

function fahrenheitTokelvin(fahrenheit){
    fahrenheit = parseFloat(fahrenheit);
     let result = Number.parseFloat(fahrenheit*5/9+255.37).toPrecision(FIXED);
    return result;
}
